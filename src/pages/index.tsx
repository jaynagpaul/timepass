...
import TimepassIcon from '../components/icons/timepass';
...
export const pageQuery = graphql`
  query {
    logo: file(relativePath: { eq: "img/logo/icon-left-font-monochrome-white.png" }) {
      childImageSharp {
        # Specify the image processing specifications right in the query.
        # Makes it trivial to update as your page's design changes.
        fixed(width: 300, height: 85, quality: 100) {
